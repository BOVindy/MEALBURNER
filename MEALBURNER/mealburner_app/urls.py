...
from .views import index, daily_view, create_meal, delete_meal, delete_activity, profile_create, update_meal, view_profile, create_activity, update_activity, cal_box, index2
#from . import views
